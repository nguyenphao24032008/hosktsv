    ...
    return (
        <>
            ...
            <GreyRowBox className={className} css={tw`flex items-center`}>
                <img
                    src={modpack.iconUrl || '/extensions/hoskt-native-version-manager/icons/modpacks.svg?v=22.1'}
                    ...
                    onError={(event) => {
                        ...
                        event.currentTarget.src = '/extensions/hoskt-native-version-manager/icons/modpacks.svg?v=22.1';
                    }}
                />
                <div css={tw`flex flex-col ml-3 w-9/12`}>
                    {modpack.url ? (
                        <a css={tw`hover:text-gray-400`} href={modpack.url} target='_blank' rel='noreferrer'>
                            {modpack.name}
