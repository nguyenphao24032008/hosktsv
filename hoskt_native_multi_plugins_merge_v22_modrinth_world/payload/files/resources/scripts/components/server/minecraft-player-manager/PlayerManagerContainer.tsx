...
export default function PlayerManagerContainer() {
    ...
    const [playerPage, setPlayerPage] = useState<'actions' | 'stats'>('actions');
                    ...
                    op(uuid, confirmOp!.name)
                        .then(() =>
                            mutate(
                                {
                                    ...query,
                                    opped: [...query.opped, { ...confirmOp!, level: 4 }],
                                },
                                false
                            )
                        )
                ...
                {confirmClear && (
                    <>
                        ...
                        <Banner
                            ...
                            icon={<FontAwesomeIcon icon={faExclamationTriangle} />}
                        >
                            Clearing a player&apos;s inventory will cause them to lose all of their items permanently.
                ...
                {!query.is_proxy ? (
                    <>
                        ...
                        {viewing === 'opped' ? (
                            ...
                            >
                                By banning players, you revoke their access to connect to the server. Banned
                                player&apos;s inventory and statistics remain the same and will not be removed. Removing
                                players from the ban list will restore their ability to connect to the server. Banning
                                IPs provides the same functionality as banning players, except it applies to all
                                connections from the specified IP address and has no relationship with the players
